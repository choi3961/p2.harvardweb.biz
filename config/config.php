...
# What is the name of this app?
	define('APP_NAME', 'Squawk Scope');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'webmaster@harvardweb.biz'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'webmaster@harvardweb.biz'); 

# Default DB name for this app
	define('DB_NAME', "harvardw_p2_harvardweb_biz"); 
...
# For this you could use gmail SMTP or something like http://sendgrid.com/
	...
	define('SMTP_USERNAME', 'choi396139@gmail.com');
	define('SMTP_PASSWORD', '3961choi');

# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'somelongstringoflettersandsymbols');
	define('TOKEN_SALT', 'differentlongstringoflettersandsymbols');